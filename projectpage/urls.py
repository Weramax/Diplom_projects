...
from .views import main, details, create_project, create_project_task, generate_pdf, delete_project_task, update_project_task, details_user,complete_task, details_task_project
